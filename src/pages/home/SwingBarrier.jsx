...
import product1 from "../home/Swing Barrier/images.jpg";
import product2 from "../home/Swing Barrier/image2.jpg";
import product3 from "../home/Swing Barrier/image3.jpg";
...
const SwingBarrier = () => {
  ...
  const brandData = {
    eSSL: {
      title: "eSSL Swing Barrier",
      desc: "The eSSL Swing Barrier offers reliable and secure access control with durability and smart operation suitable for industrial and residential areas.",
    },
    ZKTeco: {
      title: "ZKTeco Swing Barrier",
      desc: "ZKTeco swing barriers provide fast operation, intelligent control, and high security for commercial and industrial environments.",
    },
    CAME: {
      title: "CAME Swing Barrier",
      desc: "CAME swing barriers combine robust design with precision engineering for heavy-duty security applications.",
    },
    Hikvision: {
      title: "Hikvision Swing Barrier",
      desc: "Hikvision offers automated swing barriers integrated with smart monitoring and surveillance systems for secure access management.",
    },
    Honeywell: {
      title: "Honeywell Swing Barrier",
      desc: "Honeywell swing barriers deliver reliable performance with smart electronic controls suitable for high-traffic zones.",
    },
  };
